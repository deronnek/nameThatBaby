...
class TwoPlayerTrueSkillCalculator : NSObject {
        ...
        public override IDictionary<TPlayer, Rating> CalculateNewRatings<TPlayer>(GameInfo gameInfo, IEnumerable<IDictionary<TPlayer, Rating>>teams, params int[] teamRanks)
        {
            ...
            results[winner] = CalculateNewRating(gameInfo, winnerPreviousRating, loserPreviousRating, wasDraw ? PairwiseComparison.Draw : PairwiseComparison.Win);
            results[loser]  = CalculateNewRating(gameInfo, loserPreviousRating, winnerPreviousRating, wasDraw ? PairwiseComparison.Draw : PairwiseComparison.Lose);
        ...
        /// <inheritdoc/>
    func CalculateMatchQuality(gameInfo:GameInfo, teams:Dictionary<Int, Rating>) -> Double {
